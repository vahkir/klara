...
ang.onclick = () => {
  ...
  if(radio1.checked){
    titleName('Jessica');
    robotText.innerText = 'Robot Jessica';
    robname = 'jessica';
  }else if(radio2.checked){
    titleName('Michael');
    robotText.innerText = 'Robot Michael';
    robname = 'michael';
  }
};
...
rus.onclick = () => {
  ...
  if(radio1.checked){
    titleName('Клара');
    robotText.innerText = 'Робот Клара';
    robname = 'клара';
  }else if(radio2.checked){
    titleName('Давид');
    robotText.innerText = 'Робот Давид';
    robname = 'давид';
  }
...
function langtexteng() {
    ...
    you.textContent = 'You';
    robotText.textContent = 'Robot Jessica';
...
function langtextrus() {
  ...
  you.textContent = 'Вы';
  robotText.textContent = 'Робот Клара';
